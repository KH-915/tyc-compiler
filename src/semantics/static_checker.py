...
class StaticChecker(ASTVisitor):
    ...
    def visit_program(self, node: "Program", o: Any = None):
        ...
        o = {
            ...
            "functions": {
                ...
                "printInt": FuncDecl(name="printInt", return_type=VoidType(), params=[Param(IntType(), "x")], body=None),
                "printFloat": FuncDecl(name="printFloat", return_type=VoidType(), params=[Param(FloatType(), "x")], body=None),
                "printString": FuncDecl(name="printString", return_type=VoidType(), params=[Param(StringType(),"x")], body=None)
            },         # name -> FuncDecl
    ...
    def visit_identifier(self, node: "Identifier", o: Any = None):
        ...
        print(f"Finished visiting Identifier node: {node.name}")
