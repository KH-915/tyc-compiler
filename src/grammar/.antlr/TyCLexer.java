...
public class TyCLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"AUTO", "BREAK", "CONTINUE", "CASE", "DEFAULT", "ELSE", "FOR", "IF", 
			"RETURN", "STRUCT", "SWITCH", "WHILE", "INT", "FLOAT", "BOOL", "STRING", 
			"VOID", "BOOLLIT", "ADD", "SUB", "MUL", "DIV", "MOD", "OR", "AND", "NOT", 
			"INC", "DEC", "EQ", "NEQ", "LT", "LE", "GT", "GE", "ASSIGN", "ID", "INTLIT", 
			"FLOATLIT", "STRINGLIT", "DOT", "COLON", "SEMI", "COMMA", "LP", "RP", 
			"LBRACE", "RBRACE", "ESC", "STR_CHAR", "WS", "LINE_COMMENT", "BLOCK_COMMENT", 
